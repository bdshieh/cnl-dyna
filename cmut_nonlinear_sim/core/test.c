...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cmut_nonlinear_sim.core.test",
        "sources": [
            "cmut_nonlinear_sim/core/test.pyx"
        ]
    },
    "module_name": "cmut_nonlinear_sim.core.test"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cmut_nonlinear_sim__core__test
#define __PYX_HAVE_API__cmut_nonlinear_sim__core__test
/* Early includes */
#include <complex.h>
#include "basic.h"
#ifdef _OPENMP
...
/* Module declarations from 'cmut_nonlinear_sim.core.test' */
static __pyx_t_18cmut_nonlinear_sim_4core_5libh2_real __pyx_v_18cmut_nonlinear_sim_4core_4test_a;
#define __Pyx_MODULE_NAME "cmut_nonlinear_sim.core.test"
extern int __pyx_module_is_main_cmut_nonlinear_sim__core__test;
int __pyx_module_is_main_cmut_nonlinear_sim__core__test = 0;

/* Implementation of 'cmut_nonlinear_sim.core.test' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_cmut_nonlinear_sim__core__test) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cmut_nonlinear_sim.core.test")) {
      if (unlikely(PyDict_SetItemString(modules, "cmut_nonlinear_sim.core.test", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cmut_nonlinear_sim/core/test.pyx":5
 * 
 * 
 * cdef real a = 5             # <<<<<<<<<<<<<<
 * print(a)
 * 
 */
  __pyx_v_18cmut_nonlinear_sim_4core_4test_a = 5.0;

  /* "cmut_nonlinear_sim/core/test.pyx":6
 * 
 * cdef real a = 5
 * print(a)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_18cmut_nonlinear_sim_4core_4test_a); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PrintOne(0, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cmut_nonlinear_sim/core/test.pyx":8
 * print(a)
 * 
 * init_h2lib(NULL, NULL)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cmut_nonlinear_sim/core/test.pyx":13
 * # del_avector(vec)
 * 
 * uninit_h2lib()             # <<<<<<<<<<<<<<
 */
  ...
  /* "cmut_nonlinear_sim/core/test.pyx":2
 * 
 * from . libh2 cimport *             # <<<<<<<<<<<<<<
 * 
 * 
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cmut_nonlinear_sim.core.test", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cmut_nonlinear_sim.core.test");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
